...
async function song(sock, chatId, message) {
    try {
        ...
        if (!videos || videos.length === 0) {
            return await sock.sendMessage(chatId, { 
                text: "Izah mahn,cjapata doba unadai!"
            });
        }
...
export default {
  name: 'song',         // Unique name of the command
  description: 'download song',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
    console.log('song executed!');
  }
};
