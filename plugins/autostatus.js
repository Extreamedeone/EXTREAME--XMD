...
async function autoStatus(sock, chatId, msg, args) {
    try {
...
export default {
  name: 'autoStatus',         // Unique name of the command
  description: 'status init',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
    console.log('autostatus executed!');
  }
};
