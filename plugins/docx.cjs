...
import Asena from "../Utilis/events";
...
import { forwardOrBroadCast } from "../Utilis/groupmute";
import { readMore } from "../Utilis/download";
import { sticker } from "../Utilis/fFmpeg"
...
export default { topdf, wasted, mission, fancy, jail, trigger, readmore, broadcast, apk, strs,tictactoe } 
/*
bold
sans-italic
bold-italic
