...
async function stupid(sock, chatId, quotedMsg, mentionedJid, sender, args) {
    try {
...
export default {
  name: 'stupid',         // Unique name of the command
  description: 'stupid img',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
    console.log('stupid executed!');
  }
};
