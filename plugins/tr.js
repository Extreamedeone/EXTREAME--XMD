...
export default {
  name: 'download',         // Unique name of the command
  description: 'dl apk files',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
    console.log('dl executed!');
  }
};
