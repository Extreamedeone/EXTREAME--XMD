...
async function loadBadWords() {
    try {
        ...
        return [
            'fuck', 'shit', 'kino', 'bitch', 'asshole', 'cunt',
            'nigger', 'nigga', 'whore', 'slut', 'dick',
            'pussy', 'bastard', 'motherfucker', 'idiot', 'cock'
...
export default {
  name: 'antibadword',         // Unique name of the command
  description: 'Say no to badwords',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
