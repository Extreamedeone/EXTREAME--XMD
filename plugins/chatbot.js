...
async function Chatbot(sock, chatId, message, match) {
    if (!match) {
...
export default {
  name: 'chatbot',         // Unique name of the command
  description: 'interactive chatbot',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
