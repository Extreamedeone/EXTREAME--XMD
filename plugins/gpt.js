...
const openaiHandler = async (m, gss) => {
  try {
    ...
    const context = `Your name is EXTREAME-XMD, created by pilatodefury. Use casual language and appropriate emojis. Current date: ${date}. Current time: ${time}. Today is ${day}.`;
...
export default {
  name: 'openaihandler',         // Unique name of the command
  description: 'ai handler',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
    console.log('openai executed!');
  }
};
