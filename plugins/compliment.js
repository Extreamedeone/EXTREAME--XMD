...
async function compliment(sock, chatId, message) {
    try {
        if (!message || !chatId) {
...
export default {
  name: 'compliment',         // Unique name of the command
  description: 'compliments on sth/sb',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
    console.log('compliment executed!');
  }
};
