...
async function promote(sock, chatId, mentionedJids, message) {
    let userToPromote = [];
...
export default {
  name: 'promote',         // Unique name of the command
  description: 'member to admin',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
    console.log('promote executed!');
  }
};
