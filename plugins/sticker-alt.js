...
async function sticker(sock, chatId, message) {
    try {
...
export default {
  name: 'sticker',         // Unique name of the command
  description: 'Stickers maker',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
    console.log('sticker executed!');
  }
};
