...
async function warn(sock, chatId, senderId, mentionedJids, message) {
    try {
...
export default {
  name: 'warn',         // Unique name of the command
  description: 'warn pple',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
    console.log('warn executed!');
  }
};
