...
async function kick(sock, chatId, senderId, mentionedJids, message) {
...
export default {
  name: 'kick',         // Unique name of the command
  description: 'kicks group members out of the grp',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
