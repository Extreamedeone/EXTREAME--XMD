...
async function clearTmp(sock, chatId, msg) {
    try {
...
export default {
  name: 'clearTmp',         // Unique name of the command
  description: 'clears tmp dir',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
    console.log('clearTmp executed!');
  }
};
