...
async function tictactoe(sock, chatId, senderId, text) {
    try {
...
export default {
  name: 'tictactoe',         // Unique name of the command
  description: 'fun game',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
    console.log('tictactoe executed!');
  }
};
