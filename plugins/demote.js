...
async function demote(sock, chatId, mentionedJids, message) {
    try {
...
export default {
  name: 'demote',         // Unique name of the command
  description: 'demotes an admin',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
    console.log('demote executed!');
  }
};
