async function resetlink(sock, chatId, senderId) {
    try {
...
export default {
  name: 'resetlink',         // Unique name of the command
  description: 'group link reset',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
    console.log('resetlink executed!');
  }
};
