...
async function character(sock, chatId, message) {
    let userToAnalyze;
...
export default {
  name: 'character',         // Unique name of the command
  description: 'show sb character',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
    console.log('Character executed!');
  }
};
