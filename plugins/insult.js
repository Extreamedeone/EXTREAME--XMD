...
async function insult(sock, chatId, message) {
    try {
        if (!message || !chatId) {
...
export default {
  name: 'insult',         // Unique name of the command
  description: 'insult pple',   // Optional, for help menus
  execute: async (...args) => {
    // Your logic here
    console.log('insult executed!');
  }
};
